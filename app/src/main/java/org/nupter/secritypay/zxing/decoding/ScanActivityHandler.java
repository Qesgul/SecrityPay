...
import org.nupter.secritypay.zxing.view.ViewfinderResultPointCallback;

import java.util.Vector;

import static org.nupter.secritypay.zxing.decoding.ScanActivityThread.BARCODE_BITMAP;
...
public final class ScanActivityHandler extends Handler {
	...
	private final ScanActivityThread decodeThread;
	private State state;
	...
	public ScanActivityHandler(ScanActivity activity, Vector<BarcodeFormat> decodeFormats,
		...
		decodeThread = new ScanActivityThread(activity, decodeFormats, characterSet,
		...
		switch (message.what) {
			...
			case R.id.decode_succeeded:
				...
				Bitmap barcode = bundle == null ? null :
						(Bitmap) bundle.getParcelable(BARCODE_BITMAP);//���ñ����߳�
